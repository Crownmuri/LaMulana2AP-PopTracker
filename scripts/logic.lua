...
FORWARD_EXITS = {
    ...
    ["TowerOfOannesRightB"] = {{"TowerOfOannesRightA", "False"}, {"TowerOfOannesRightBCrystal", "CanWarp or Has(Feather)"}},
    ["TowerOfOannesRightBCrystal"] = {{"BaileyBottom", "True"}, {"TowerOfOannesRightB", "True"}},
